...
function Heading(props: HeadingProps) {
  ...
  if (props.level === "2") {
    return (
      <h2 className="text-center font-serif text-[56px] uppercase leading-none tracking-[0px] text-white md:text-[20px] md:tracking-[3.38px] lg:text-[28px] lg:tracking-[4.75px]">
        {props.children}
      </h2>
    );
  }
